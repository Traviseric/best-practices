...
Core patterns for running AI coding agents reliably — pulled from production overnight runs.
...
| File-Based State | Production | Task file as source of truth |
| Landing the Plane | Yegge | Git checkpoint after each round |
| Worker Isolation | Production | Independent terminal per worker |
| Handoff Continuity | Production | Handoff file passes context forward |
...
How these patterns map to [12-factor-agents](https://github.com/humanlayer/12-factor-agents):

| 12-Factor | Pattern | Status |
|-----------|---------|--------|
| Factor 3: Own your context | Fresh Context | ✅ Core pattern |
| Factor 5: Unify state | File-Based State | ✅ Core pattern |
| Factor 6: Launch/Pause/Resume | - | ⚠️ Launch only |
| Factor 9: Compact errors | Run logs | ⚠️ Basic |
| Factor 10: Small agents | Worker Isolation | ✅ Core pattern |

---

## Attribution

These patterns were developed across many production overnight runs, and align with community work:
